...
export default function Card(props: PropsWithChildren<CardProps>): JSX.Element{
    ...
    <article className={`group relative rounded-xl bg-${color} p-5 content-end ${style} lg:w-72 lg:h-96 lg:pt-64 lg:hover:pt-0 lg:hover:pb-6 lg:ease-in-out lg:duration-[1500ms] overflow-hidden`}>
        ...
        <FaceLeftIcon color="black" styles="float-right md:absolute top-0 lg:right-3 " size="40px"/>
        ...
        <Paragraph theme="light" weight="medium" styles="lg:text-base xl:text-sm ease-in-out delay-300 lg:duration-[500ms] lg:pt-10 lg:pb-5 lg:group-hover:pt-0 lg:leading-tight xl:leading-tight">{children}</Paragraph>
    </article>
